        ...
        >
          ...
          <span>
            ...
            >
              ...
              <b-dropdown-item @click="callDeleteMethod('/deleteAppName', data={id:props.row.id}, 'post')">
                <feather-icon
                    class="mr-50"
                    icon="TrashIcon"
                />
...
export default {
    ...
    methods: {
        async showModal(value) {
            if (value) {
                this.data.id = value
                const callAxios = await this.callAxios('/getSingleAppname', { id: value }, 'post')
                console.log(callAxios)
                this.data.appName = callAxios.data[0]['app_name']
                this.data.appValue = callAxios.data[0]['app_value']
            ...
            this.$refs.simpleRules.validate()
                .then(async success => {
                    if (success) {
                        ...
                        const callAxios = await this.callAxios('/saveAppName', this.data, 'post')
