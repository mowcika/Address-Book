        ...
        function dispatchEvent(_ref) {
            ...
            var evt,
                ...
                onName = 'on' + name.charAt(0)
                    .toUpperCase() + name.substr(1) // Support for new CustomEvent feature
...
// CONCATENATED MODULE: ./src/vuedraggable.js
                        ...
                        function _computeIndexes(slots, children, isTransition, footerOffset) {
                            ...
                            var rawIndexes = _toConsumableArray(children)
                        ...
                        var readonlyProperties = ['Move'].concat(eventsListened, eventsToEmit)
                            .map(function (evt) {
                                return 'on' + evt
                            })
                        ...
                        var draggableComponent = {
                            ...
                            mounted: function mounted() {
                                ...
                                this.noneFunctionalComponentMode = this.getTag()
                                    .toLowerCase() !== this.$el.nodeName.toLowerCase() && !this.getIsFunctional()
                                ...
                                var attributes = Object.keys(this.$attrs)
                                    .reduce(function (res, key) {
                            ...
                            methods: {
                                ...
                                computeFutureIndex: function computeFutureIndex(relatedContext, evt) {
                                    ...
                                    var domChildren = _toConsumableArray(evt.to.children)
                                        .filter(function (el) {
