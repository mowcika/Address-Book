...
// Exports
        ...
        function FlatpickrInstance(element, instanceConfig) {
            ...
            function bindEvents() {
                ...
                if (self.timeContainer !== undefined &&
                    ...
                    var selText = function (e) {
                        return Object(_utils_dom__WEBPACK_IMPORTED_MODULE_3__['getEventTarget'])(e)
                            .select()
                    }
            ...
            function createDay(className, date, _dayNumber, i) {
                var dateIsEnabled = isEnabled(date, true),
                    dayElement = Object(_utils_dom__WEBPACK_IMPORTED_MODULE_3__['createElement'])('span', className, date.getDate()
                        .toString())
            ...
            function buildMonthSwitch() {
                ...
                for (var i = 0; i < 12; i++) {
                    ...
                    month.value = new Date(self.currentYear, i).getMonth()
                        .toString()
            ...
            function buildMonth() {
                ...
                if (self.config.minDate) {
                    yearElement.setAttribute('min', self.config.minDate.getFullYear()
                        .toString())
                }
                if (self.config.maxDate) {
                    yearElement.setAttribute('max', self.config.maxDate.getFullYear()
                        .toString())
            ...
            function parseConfig() {
                ...
                _types_options__WEBPACK_IMPORTED_MODULE_0__['HOOKS'].filter(function (hook) {
                    ...
                    .forEach(function (hook) {
                        self.config[hook] = Object(_utils__WEBPACK_IMPORTED_MODULE_2__['arrayify'])(self.config[hook] || [])
                            .map(bindToInstance)
                    })
                self.isMobile =
            ...
            function updateNavigationCurrentMonth() {
                ...
                self.yearElements.forEach(function (yearElement, i) {
                    ...
                    if (self.config.showMonths > 1 ||
                        ...
                        self.monthsDropdownContainer.value = d.getMonth()
                            .toString()
                    }
  ...
  \************************************************************************/
    ...
    /***/ (function (module, exports, __webpack_require__) {
        ...
        !function (t, e) {
            true ? module.exports = e(__webpack_require__(/*! flatpickr */ './node_modules/flatpickr/dist/esm/index.js')) : undefined
                    ...
                    c = {
                        ...
                        mounted: function () {
                            ...
                            if (!this.fp) {
                                ...
                                })), e.defaultDate = this.value || e.defaultDate, this.fp = new o.a(this.getElem(), e), this.fpInput()
                                    .addEventListener("blur", this.onBlur), this.$on("on-close", this.onClose), this.$watch("disabled", this.watchDisabled, { immediate: !0 })
                            }
                        },
                        methods: {
                            getElem: function () {
                            ...
                            watchDisabled: function (t) {
                                t ? this.fpInput()
                                    .setAttribute("disabled", t) : this.fpInput()
                        ...
                        beforeDestroy: function () {
                            this.fp && (this.fpInput()
                                .removeEventListener("blur", this.onBlur), this.fp.destroy(), this.fp = null)
                        }
                    },
                    p = function (t, e) {
                        var n = "flat-pickr";
