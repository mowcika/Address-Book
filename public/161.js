(window['webpackJsonp'] = window['webpackJsonp'] || []).push([[161], {
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        __webpack_require__.d(__webpack_exports__, 'VueAutosuggest', function () {
            return VueAutosuggest
        })
        /* harmony export (binding) */
        __webpack_require__.d(__webpack_exports__, 'DefaultSection', function () {
        ...
        var DefaultSection = {
            ...
            render: function (t) {
                var e = this,
                    ...
                    i = n + '__results-before ' + n + '__results-before--' + this.section.name,
                    r = s.beforeSection && s.beforeSection({
                ...
                }, [r[0] && r[0] || this.section.label && t('li', {
                    class: i,
                    id: this.componentAttrIdAutosuggest + '-' + this.section.label
                }, this.section.label) || '', this.list.map(function (s, i) {
                    var r,
                        o = e.normalizeItemFunction(e.section.name, e.section.type, e.section.label, e.section.liClass, s),
                        u = e.getItemIndex(i),
                        l = e._currentIndex === u || parseInt(e.currentIndex) === u
                    return t('li', {
                        attrs: Object.assign({}, {
                            role: 'option',
                            'data-suggestion-index': u,
                            'data-section-name': o.name,
                            id: n + '__results-item--' + u
                        }, o.liAttributes),
                        key: u,
                        class: Object.assign((r = {}, r[n + '__results-item--highlighted'] = l, r[n + '__results-item'] = !0, r), o.liClass),
                        on: {
                            mouseenter: e.onMouseEnter,
                            mouseleave: e.onMouseLeave
                        }
                    }, [e.renderSuggestion ? e.renderSuggestion(o) : e.$scopedSlots.default && e.$scopedSlots.default({
                        _key: i,
                        suggestion: o
                    })])
                }), s.afterSectionDefault && s.afterSectionDefault({
                    section: this.section,
                    className: n + '__results-after ' + n + '__results-after--' + this.section.name
                }), s.afterSectionNamed && s.afterSectionNamed({
                    section: this.section,
                    className: n + '__results_after ' + n + '__results-after--' + this.section.name
                })])
            }
        }
            ...
            VueAutosuggest = {
                render: function () {
                    var t = this,
                        e = t.$createElement,
                        n = t._self._c || e
                    return n('div', { attrs: { id: t.componentAttrIdAutosuggest } }, [t._t('before-input'), n('div', {
                        attrs: {
                            role: 'combobox',
                            'aria-expanded': t.isOpen ? 'true' : 'false',
                            'aria-haspopup': 'listbox',
                            'aria-owns': t.componentAttrIdAutosuggest + '-' + t.componentAttrPrefix + '__results'
                        }
                    }, [n('input', t._g(t._b({
                        class: [t.isOpen ? t.componentAttrPrefix + '__input--open' : '', t.internal_inputProps.class],
                        attrs: {
                            type: t.internal_inputProps.type,
                            autocomplete: t.internal_inputProps.autocomplete,
                            'aria-autocomplete': 'list',
                            'aria-activedescendant': t.isOpen && null !== t.currentIndex ? t.componentAttrPrefix + '__results-item--' + t.currentIndex : '',
                            'aria-controls': t.componentAttrIdAutosuggest + '-' + t.componentAttrPrefix + '__results'
                        },
                    ...
                    }, 'input', t.internal_inputProps, !1), t.listeners))]), t._t('after-input'), t._v(' '), n('div', {
                        class: t._componentAttrClassAutosuggestResultsContainer,
                        attrs: { id: t.componentAttrIdAutosuggest + '-' + t.componentAttrPrefix + '__results' }
                    }, [t.isOpen ? n('div', {
                        class: t._componentAttrClassAutosuggestResults,
                        attrs: { 'aria-labelledby': t.componentAttrIdAutosuggest }
                    }, [t._t('before-suggestions'), t._v(' '), t._l(t.computedSections, function (e, s) {
                        return n(e.type, {
                            key: t.getSectionRef('' + e.name + s),
                            ref: t.getSectionRef('' + e.name + s),
                            refInFor: !0,
                            tag: 'component',
                            attrs: {
                                ...
                                section: e,
                                'component-attr-prefix': t.componentAttrPrefix,
                                'component-attr-id-autosuggest': t.componentAttrIdAutosuggest
                            },
                            on: { updateCurrentIndex: t.updateCurrentIndex },
                            scopedSlots: t._u([{
                                key: 'before-section-' + (e.name || e.label),
                                fn: function (n) {
                                    var s = n.section,
                                        i = n.className
                                    return [t._t('before-section-' + (e.name || e.label), null, {
                                        section: s,
                                        className: i
                                    })]
                                }
                                ...
                                fn: function (n) {
                                    var s = n.section
                                    return [t._t('after-section-' + (e.name || e.label), null, { section: s })]
                                }
                            }, {
                                key: 'after-section',
                                fn: function (e) {
                                    var n = e.section
                                    return [t._t('after-section', null, { section: n })]
                                }
                            }])
                        })
                ...
                staticRenderFns: [],
                name: 'Autosuggest',
                components: { DefaultSection: DefaultSection },
                props: {
                    value: {
                        type: String,
                        default: null
                ...
                computed: {
                    ...
                    listeners: function () {
                        ...
                        return Object.assign({}, this.$listeners, {
                            ...
                            click: function () {
                                t.loading = !1, t.$listeners.click && t.$listeners.click(t.currentItem), t.$nextTick(function () {
                        ...
                        return this.suggestions.map(function (n) {
                            if (n.data) {
                                var s,
                                    ...
                                    r,
                                    o,
                                    u = n.name ? n.name : defaultSectionConfig.name,
                                    l = null
                ...
                methods: {
                    ...
                    getItemByIndex: function (t) {
                        ...
                        for (var n = 0; n < this.computedSections.length; n++) {
                            if (t >= this.computedSections[n].start_index && t <= this.computedSections[n].end_index) {
                                var s = t - this.computedSections[n].start_index,
                                    i = this.computedSections[n].name,
                                    r = this.$refs[this.getSectionRef('' + i + n)][0]
                                if (r) {
                    ...
                    handleKeyStroke: function (t) {
                        ...
                        if (!([16, 9, 17, 18, 91, 93].indexOf(n) > -1)) {
                            var s = !this.isOpen
                            if (this.loading = !1, this.didSelectFromOptions = !1, this.isOpen) {
                                switch (n) {
                                    case 40:
                                    case 38:
                                        if (t.preventDefault(), 38 === n && null === this.currentIndex) break
                                        var i = 40 === n ? 1 : -1,
                                            r = Math.max((parseInt(this.currentIndex) || 0) + (s ? 0 : i), INDEX_IS_FOCUSED_ON_INPUT)
                                        this.setCurrentIndex(r, this.totalResults), this.didSelectFromOptions = !0, this.totalResults > 0 && this.currentIndex >= 0 ? (this.setChangeItem(this.getItemByIndex(this.currentIndex)), this.didSelectFromOptions = !0) : this.currentIndex === INDEX_IS_FOCUSED_ON_INPUT && (this.setChangeItem(null), this.internalValue = this.searchInputOriginal, t.preventDefault()), this.$nextTick(function () {
                                            e.ensureItemVisible(e.currentItem, e.currentIndex)
                                        })
                                        break
                                    case 13:
                                        t.preventDefault(), this.totalResults > 0 && this.currentIndex >= 0 && (this.setChangeItem(this.getItemByIndex(this.currentIndex), !0), this.didSelectFromOptions = !0), this.loading = !0, this.listeners.selected(this.didSelectFromOptions)
                                        break
                                    case 27:
                                        this.loading = !0, this.currentIndex = null, this.internalValue = this.searchInputOriginal, this.$emit('input', this.searchInputOriginal), t.preventDefault()
                                }
                            }
                        }
                    },
                    setChangeItem: function (t, e) {
                        if (void 0 === e && (e = !1), null !== this.currentIndex && t) {
                            if (t) {
                    ...
                    updateCurrentIndex: function (t) {
                        this.setCurrentIndex(t, -1, !0)
                    },
                    clickedOnScrollbar: function (t, e) {
                        var n = this.$el.querySelector('.' + this._componentAttrClassAutosuggestResults),
                            s = n && n.clientWidth <= e + 17 && e + 17 <= n.clientWidth + 34
                        return 'DIV' === t.target.tagName && n && s || !1
                    },
                    ...
                    onDocumentMouseUp: function (t) {
                        if (!this.$el.contains(t.target)) return this.loading = !0, void (this.currentIndex = null)
                        'INPUT' === t.target.tagName || this.clickedOnScrollbar(t, this.clientXMouseDownInitial) || (this.loading = !0, this.didSelectFromOptions = !0, this.setChangeItem(this.getItemByIndex(this.currentIndex), !0), this.listeners.selected(!0))
                    },
                    setCurrentIndex: function (t, e, n) {
                        ...
                        this.currentIndex = s
                        var i = this.$el.querySelector('#' + this.componentAttrPrefix + '__results-item--' + this.currentIndex),
                            r = this.componentAttrPrefix + '__results-item--highlighted'
        ...
        "undefined" != typeof window && window.Vue && window.Vue.use(VueAutosuggestPlugin);/* harmony default export */
        __webpack_exports__["default"] = (VueAutosuggestPlugin);
