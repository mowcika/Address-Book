 ...
 */
            ...
            function c(t, e) {
                var r = t.element.classList,
                    i = Y.state.scrolling(e)
                r.contains(i) ? clearTimeout(_[e]) : r.add(i)
            }
            ...
            function y(t, e) {
                function r(e) {
                    b[p] = v + m * (e[l] - g), c(t, d), T(t), e.stopPropagation(), e.preventDefault()
                }
                ...
                t.event.bind(t[a], 'mousedown', function (e) {
                    v = b[p], g = e[l], m = (t[o] - t[n]) / (t[s] - t[u]), t.event.bind(t.ownerDocument, 'mousemove', r), t.event.once(t.ownerDocument, 'mouseup', i), t[f].classList.add(Y.state.clicking), e.stopPropagation(), e.preventDefault()
                })
            }
            ...
            var L = function (t, e, r, i, n) {
                ...
                T = function (t) {
                    ...
                    t.containerWidth = e.clientWidth, t.containerHeight = e.clientHeight, t.contentWidth = e.scrollWidth, t.contentHeight = e.scrollHeight, e.contains(t.scrollbarXRail) || (a(e, Y.element.rail('x'))
                        .forEach(function (t) {
                            return s(t)
                        }), e.appendChild(t.scrollbarXRail)), e.contains(t.scrollbarYRail) || (a(e, Y.element.rail('y'))
                        .forEach(function (t) {
                            return s(t)
                ...
                E = function (t) {
                    ...
                    t.event.bind(t.ownerDocument, 'keydown', function (o) {
                        if (!(o.isDefaultPrevented && o.isDefaultPrevented() || o.defaultPrevented) && (i() || n())) {
                ...
                M = function (t) {
                    function e(e, r) {
                        ...
                        return !(Math.abs(r) > Math.abs(e) ? n || o : s || a) || !t.settings.wheelPropagation
                    }
                    ...
                    function n(t, e, r) {
                        ...
                        for (var n = t; n && n !== l;) {
                            if (n.classList.contains(Y.element.consuming)) return !0
                            var o = i(n)
                            if ([o.overflow, o.overflowX, o.overflowY].join('')
                                .match(/(scroll|auto)/)) {
                ...
                k = function (t) {
                    function e(e, r) {
                        var i = Math.floor(h.scrollTop),
                            ...
                            l = Math.abs(r)
                        if (l > o) {
                            if (r < 0 && i === t.contentHeight - t.containerHeight || r > 0 && 0 === i) return 0 === window.scrollY && r > 0 && R.isChrome
                ...
                C = function (t, e) {
                    ...
                    this.element = t, t.classList.add(Y.main), this.settings = A()
                    for (var l in e) r.settings[l] = e[l]
                    ...
                    this.scrollbarXBottom = parseInt(c.bottom, 10), isNaN(this.scrollbarXBottom) ? (this.isScrollbarXUsingBottom = !1, this.scrollbarXTop = f(c.top)) : this.isScrollbarXUsingBottom = !0, this.railBorderXWidth = f(c.borderLeftWidth) + f(c.borderRightWidth), n(this.scrollbarXRail, { display: 'block' }), this.railXMarginWidth = f(c.marginLeft) + f(c.marginRight), n(this.scrollbarXRail, { display: '' }), this.railXWidth = null, this.railXRatio = null, this.scrollbarYRail = o(Y.element.rail('y')), t.appendChild(this.scrollbarYRail), this.scrollbarY = o(Y.element.thumb('y')), this.scrollbarYRail.appendChild(this.scrollbarY), this.scrollbarY.setAttribute('tabindex', 0), this.event.bind(this.scrollbarY, 'focus', s), this.event.bind(this.scrollbarY, 'blur', a), this.scrollbarYActive = null, this.scrollbarYHeight = null, this.scrollbarYTop = null
                    var h = i(this.scrollbarYRail)
                    this.scrollbarYRight = parseInt(h.right, 10), isNaN(this.scrollbarYRight) ? (this.isScrollbarYUsingRight = !1, this.scrollbarYLeft = f(h.left)) : this.isScrollbarYUsingRight = !0, this.scrollbarYOuterWidth = this.isRtl ? v(this.scrollbarY) : null, this.railBorderYWidth = f(h.borderTopWidth) + f(h.borderBottomWidth), n(this.scrollbarYRail, { display: 'block' }), this.railYMarginHeight = f(h.marginTop) + f(h.marginBottom), n(this.scrollbarYRail, { display: '' }), this.railYHeight = null, this.railYRatio = null, this.reach = {
            ...
            C.prototype.update = function () {
                this.isAlive && (this.negativeScrollAdjustment = this.isNegativeScroll ? this.element.scrollWidth - this.element.clientWidth : 0, n(this.scrollbarXRail, { display: 'block' }), n(this.scrollbarYRail, { display: 'block' }), this.railXMarginWidth = f(i(this.scrollbarXRail).marginLeft) + f(i(this.scrollbarXRail).marginRight), this.railYMarginHeight = f(i(this.scrollbarYRail).marginTop) + f(i(this.scrollbarYRail).marginBottom), n(this.scrollbarXRail, { display: 'none' }), n(this.scrollbarYRail, { display: 'none' }), T(this), L(this, 'top', 0, !1, !0), L(this, 'left', 0, !1, !0), n(this.scrollbarXRail, { display: '' }), n(this.scrollbarYRail, { display: '' }))
            ...
            function r(t, e) {
                for (var r = 0; r < t.length; r++) {
                    ...
                    if (n) {
                        ...
                        for (; o < i.parts.length; o++) n.parts.push(s(i.parts[o], e))
                    } else {
                        for (var l = [], o = 0; o < i.parts.length; o++) l.push(s(i.parts[o], e))
                        h[i.id] = {
                            id: i.id,
                            refs: 1,
                            parts: l
            ...
            function n(t, e) {
                var r = d(),
                    i = v[v.length - 1]
                if ('top' === t.insertAt) {
                    i ? i.nextSibling ? r.insertBefore(e, i.nextSibling) : r.appendChild(e) : r.insertBefore(e, r.firstChild), v.push(e)
                } else {
            ...
            function s(t, e) {
                ...
                if (e.singleton) {
                    var s = b++
                    r = f || (f = l(e)), i = a.bind(null, r, s, !1), n = a.bind(null, r, s, !0)
                } else {
                    r = l(e), i = c.bind(null, r), n = function () {
                        o(r)
                    }
                }
            ...
            function c(t, e) {
                var r = e.css,
                    i = e.media,
                    n = e.sourceMap
                if (i && t.setAttribute('media', i), n && (r += '\n/*# sourceURL=' + n.sources[0] + ' */', r += '\n/*# sourceMappingURL=data:application/json;base64,' + btoa(unescape(encodeURIComponent(JSON.stringify(n)))) + ' */'), t.styleSheet) {
