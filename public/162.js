  ...
  \****************************************************************/
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        (function (global) {/* harmony export (binding) */
            __webpack_require__.d(__webpack_exports__, 'VueGoodTable', function () {
 ...
 */
            ...
            var defaultType = {
                ...
                filterPredicate: function filterPredicate(rowval, filter) {
                    ...
                    var searchTerm = skipDiacritics ? filter.toLowerCase() : diacriticless(escapeRegExp(filter)
            ...
            var script = {
                ...
                computed: {
                    pageInfo: function pageInfo() {
                        return ''.concat(this.ofText, ' ')
                            .concat(this.lastPage)
                    },
            ...
            var script$3 = {
                ...
                methods: {
                    ...
                    getClasses: function getClasses(column) {
                        ...
                        return column.filterOptions && column.filterOptions.styleClass ? [firstClass].concat(_toConsumableArray(column.filterOptions.styleClass.split(' ')))
                            .join(' ') : firstClass
                    },
                ...
                mounted: function mounted() {
                    ...
                    this.$nextTick(function () {
                        ...
                        if ('ResizeObserver' in window) {
                            ...
                            if (_this.tableRef) {
                                Array.from(_this.$parent.$refs['table-header-primary'].$el.children[0].children)
...
//
            ...
            function addMilliseconds(dirtyDate, dirtyAmount) {
                ...
                var timestamp = toDate(dirtyDate)
                    .getTime()
...
// See issue: https://github.com/date-fns/date-fns/issues/376
            ...
            function getUTCISOWeek(dirtyDate) {
                requiredArgs(1, arguments)
                var date = toDate(dirtyDate)
                var diff = startOfUTCISOWeek(date)
                    .getTime() - startOfUTCISOWeekYear(date)
...
// See issue: https://github.com/date-fns/date-fns/issues/376
            ...
            function getUTCWeek(dirtyDate, options) {
                requiredArgs(1, arguments)
                var date = toDate(dirtyDate)
                var diff = startOfUTCWeek(date, options)
                    .getTime() - startOfUTCWeekYear(date, options)
                    .getTime() // Round the number of days to the nearest integer
                // because the number of milliseconds in a week is not constant
                // (e.g. it's different in the week of the daylight saving time clock shift)
   ...
   */
            ...
            function dateTimeLongFormatter(pattern, formatLong) {
                ...
                return dateTimeFormat.replace('{{date}}', dateLongFormatter(datePattern, formatLong))
            ...
            function throwProtectedError(token, format, input) {
                if (token === 'YYYY') {
                    throw new RangeError('Use `yyyy` instead of `YYYY` (in `'.concat(format, '`) for formatting years to the input `')
                        .concat(input, '`; see: https://git.io/fxCyr'))
                } else if (token === 'YY') {
                    throw new RangeError('Use `yy` instead of `YY` (in `'.concat(format, '`) for formatting years to the input `')
                        .concat(input, '`; see: https://git.io/fxCyr'))
                } else if (token === 'D') {
                    throw new RangeError('Use `d` instead of `D` (in `'.concat(format, '`) for formatting days of the month to the input `')
                        .concat(input, '`; see: https://git.io/fxCyr'))
                } else if (token === 'DD') {
                    throw new RangeError('Use `dd` instead of `DD` (in `'.concat(format, '`) for formatting days of the month to the input `')
                        .concat(input, '`; see: https://git.io/fxCyr'))
                }
            }
...
// sequences of symbols P, p, and the combinations like `PPPPPPPppppp`
            ...
            function format(dirtyDate, dirtyFormatStr, dirtyOptions) {
                ...
                var result = formatStr.match(longFormattingTokensRegExp)
...
// sequences of symbols P, p, and the combinations like `PPPPPPPppppp`
            ...
            function parse(dirtyDateString, dirtyFormatString, dirtyReferenceDate, dirtyOptions) {
                ...
                var i
                var tokens = formatString.match(longFormattingTokensRegExp$1)
                    .map(function (substring) {
                        var firstCharacter = substring[0]
                    ...
                    if (parser) {
                        ...
                        if (Array.isArray(incompatibleTokens)) {
                            ...
                            if (incompatibleToken) {
                                throw new RangeError('The format string mustn\'t contain `'.concat(incompatibleToken.fullToken, '` and `')
            ...
            decimal.format = function (v) {
                ...
                return parseFloat(Math.round(v * 100) / 100)
                    .toFixed(2)
            }
            ...
            percentage.format = function (v) {
                if (v === undefined || v === null) return ''
                return ''.concat(parseFloat(v * 100)
                    .toFixed(2), '%')
            }
            ...
            Object.keys(coreDataTypes)
                .forEach(function (key) {
                    var compName = key.replace(/^\.\//, '')
                        .replace(/\.js/, '')
            ...
            var script$6 = {
                ...
                computed: {
                    ...
                    selectionInfo: function selectionInfo() {
                        return ''.concat(this.selectedRowCount, ' ')
            ...
            __webpack_exports__['default'] = (VueGoodTablePlugin)
